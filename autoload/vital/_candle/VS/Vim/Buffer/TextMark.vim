...
execute join(['function! vital#_candle#VS#Vim#Buffer#TextMark#import() abort', printf("return map({'clear': '', 'set': '', 'is_available': '', 'get': ''}, \"vital#_candle#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
"
